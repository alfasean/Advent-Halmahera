...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO tb_baptis (id_user, nama_lengkap, waktu_baptis, tempat_lahir, tgl_lahir, no_wa, gmail, kk, akta_kelahiran, status)
            VALUES ('$id_user', '$nama_lengkap', '$waktu_baptis', '$tempat_lahir', '$tgl_lahir', '$no_wa', '$gmail', '$kk', '$akta_kelahiran', '$status')";
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        echo '<script>
                Swal.fire({
                    ...
                    window.location.href = "index.php?p=data_baptis";
                });
              </script>';
    } else {
...
<head>
    <meta charset="UTF-8">
    <title>Formulir Pendaftaran Baptisan</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input type="file" id="kk" name="kk" accept=".pdf, .jpg, .jpeg, .png" required><br><br>

            <label for="akta_kelahiran">Upload Akta Kelahiran:</label>
            <input type="file" id="akta_kelahiran" name="akta_kelahiran" accept=".pdf, .jpg, .jpeg, .png" required><br><br>
