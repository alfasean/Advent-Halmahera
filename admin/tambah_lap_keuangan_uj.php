...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $saldo_saat_ini = $jumlah - $pengeluaran;
        ...
        $sql = "INSERT INTO tb_laporan_keuangan_uj (uraian, saldo_januari, masuk_februari, jumlah, pengeluaran, saldo_saat_ini)
        ...
        if ($conn->query($sql) === TRUE) {
            ...
            echo '<script>window.location.href = "admin.php?p=lap_keuangan_uj";</script>';
            exit();
        } else {
