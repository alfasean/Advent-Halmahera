...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE tb_depart_penata_layanan SET nama='$nama', status='$status' WHERE id_depart_pl='$_GET[menu_upd]'";
...
<body>
    ...
    if (isset($_GET['menu_upd'])) {
        $sql = "SELECT * FROM tb_depart_penata_layanan WHERE id_depart_pl='$_GET[menu_upd]'";
