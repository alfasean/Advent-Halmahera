...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE tb_laporan_keuangan_uj SET uraian='$uraian', saldo_januari='$saldo_januari', masuk_februari='$masuk_februari', jumlah='$jumlah', pengeluaran='$pengeluaran', saldo_saat_ini='$saldo_saat_ini' WHERE id_laporan_keuangan='$_GET[menu_upd]'";
...
<body>
    ...
    if (isset($_GET['menu_upd'])) {
        $sql = "SELECT * FROM tb_laporan_keuangan_uj WHERE id_laporan_keuangan_uj='$_GET[menu_upd]'";
